...
public class ParameterResolver {
	...
	Entry<String, List<Entry<String, String>>> replaceParameterByValue(CrySLRule rule,
		...
		for (Entry<String, String> parameter : parametersOfCall) {
			...
			String value = constraintResolver.analyseConstraints(parameter, rule, testClass, methodNamdResultAssignment.substring(methodNamdResultAssignment.lastIndexOf(".") + 1));
			if (!value.isEmpty()) {
